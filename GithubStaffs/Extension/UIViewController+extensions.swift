...
public extension UIViewController {
    ...
    func addChildViewController(_ child: UIViewController, toContainerView containerView: UIView, isOverSafeArea: Bool = true) {
        addChild(child)
        ...
        child.view.snp.makeConstraints { maker in
            if isOverSafeArea {
                ...
                maker.top.bottom.leading.trailing.equalTo(containerView.safeAreaInsets)
            }
